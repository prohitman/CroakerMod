...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<CroakerEntity>> CROAKER = ENTITY_TYPES.register("croaker", () -> EntityType.Builder.of(CroakerEntity::new, MobCategory.MONSTER).sized(2F, 2F).clientTrackingRange(20).build("croaker"));
}
